...
RETURN x.weight AS weight, toString(startnode(x).bodyId) AS startId, startnode(x).type AS startType, toString(endnode(x).bodyId) AS endBody, endnode(x).type AS endType
