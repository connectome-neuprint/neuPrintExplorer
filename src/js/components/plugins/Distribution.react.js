  ...
  render() {
    ...
    return (
      <FormControl className={classes.formControl}>
        <Select value={this.state.qsParams.roi} onChange={this.setROI}>
        ...
        >
          <MenuItem key={'presyn'} value={'presyn'}>
            Pre-synaptic
          </MenuItem>
          <MenuItem key={'postsyn'} value={'postsyn'}>
            Post-synaptic
          </MenuItem>
        </Select>
          ...
          onClick={() => {
            this.props.callback(
              queryDistribution(
                ...
                this.state.qsParams.roi,
                this.state.qsParams.type
              )
            );
          }}
        >
